import type { ISSTResource } from "../types/sst";
import type { IWorkflowNode, IWorkflow, TWorkflowNodeStatus } from "../types/workflow";
...
export function buildWorkflow(
  resources: ISSTResource[],
  relationships: ReturnType<typeof import("./relationships").parseResourceRelationships>
): IWorkflow {
