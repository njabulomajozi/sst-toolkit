# SST Toolkit Documentation

Welcome to the SST Toolkit documentation! This guide will help you get started with exploring, visualizing, and extending SST.

## 📚 Documentation Structure

### Getting Started
- **[Quick Start Guide](./GETTING_STARTED.md)** - Get up and running quickly
- **[Installation](./GETTING_STARTED.md#installation)** - Installation instructions

### Guides
- **[Creating Components](./guides/creating-components.md)** - Learn how to create custom SST components
...
1. Read [Creating Components](./guides/creating-components.md)
2. Check [Component Examples](./examples/components.md)
3. Follow [Best Practices](./guides/best-practices.md)

### I want to use an existing component
1. Read [Using Components](./guides/using-components.md)
2. Check [Integration Examples](./examples/integration.md)

### I want to explore my infrastructure
1. Read [Exploring Infrastructure](./guides/exploring-infrastructure.md)
...
- **New to SST Toolkit?** Start with [Getting Started](./GETTING_STARTED.md)
- **Creating components?** See [Creating Components](./guides/creating-components.md)
